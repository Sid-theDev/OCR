...
# Creating a validation data provider
...
model = train_model(
    input_dim=(configs.height, configs.weight, 3),
...
model.fit(
    ...
    callback=[earlystopper, checkpoint, trainLogger, reduceLROnPlat, tb_callback, model2onnx],
